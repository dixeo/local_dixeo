...
$string['privacy:metadata:external:files'] = 'Ficheiros do curso e texto SCORM extraído carregados para sincronização ou RAG.';
$string['privacy:metadata:external:instructions'] = 'Instruções ou prompts usados para orientar o processamento AI.';
$string['privacy:metadata:external:message'] = 'Mensagens do tutor ou do utilizador enviadas para processamento AI.';
$string['privacy:metadata:external:moduletype'] = 'O tipo de módulo de atividade pedido para geração.';
$string['privacy:metadata:external:namespace'] = 'O namespace do site usado para separar os dados desta instância Moodle na API Dixeo.';
$string['privacy:metadata:external:userid'] = 'O ID do utilizador Moodle associado ao pedido (por exemplo conversas do tutor).';
